...
Minim minim;
ddf.minim.AudioPlayer masterAudioPlayer;

float singleSoundDuration = 2.5; // The duration of the single sound (in seconds)
AudioSamples singleSoundSamples; // For storing the sound samples for a single sound

float soundSequenceDuration = totalSoundNeedToBeGenerated * singleSoundDuration; // The duration of the 19-sound sequence (in seconds)
AudioSamples soundSequenceSamples; // For storing the 19-sound samples

float musicDuration = 260;  // The duration of the complete sound sequence (in seconds)
...
void updateSoundInfo() {
  ...
  switch(sound.getId()) {
  case 1: 
    result = "Sine (Time Domain Method)"; 
    break;
  case 2: 
    result = "Square (Time Domain Method)"; 
    break;
  case 3: 
    result = "Square (Additive Synthesis)"; 
    break;
  case 4: 
    result = "Sawtooth (Time Domain Method)"; 
    break;
  case 5: 
    result = "Sawtooth (Additive Synthesis)"; 
    break;
  case 6: 
    result = "Triangle (Additive Synthesis)"; 
    break;
  case 7: 
    result = "Bell"; 
    break;
  case 8: 
    result = "Karplus-Strong Algorithm"; 
    break;
  case 9: 
    result = "White Noise"; 
    break;
  case 10: 
    ...
    break;
  case 11: 
    result = "Repeating Narrow Pulse"; 
    break;
  case 12: 
    result = "Triangle (Time Domain Method)"; 
    break;
  case 13: 
    result = "Science Fiction Movie Sound"; 
    break;
  case 14: 
    result = "Non-string Karplus-Strong Sound"; 
    break;
  case 15: 
    result = "Sound 1 x Sound 1"; 
    break;
  case 16: 
    result = "Sound 1 x Sound 5"; 
    break;
  case 17: 
    result = "Sound 1 x Sound 10"; 
    break;
  case 18: 
    result = "Sound 4 x Sound 4"; 
    break;
  case 19: 
    result = "Sound 5 x Sound 6"; 
    break;
  case 20: 
    result = "Your Own Sound"; 
    break;
  case 21: 
    result = "Your Own Sound"; 
    break;
  ...
  for (int i = 0; i < postprocesses.length; ++i) {
    ...
    case 1: 
      ...
      break;
    case 2: 
      result += ", then Exponential Decay"; 
      break;
    case 3: 
      result += ", then Low Pass Filter"; 
      break;
    case 4: 
      result += ", then Band Reject Filter"; 
      break;
    case 5: 
      result += ", then Fade In"; 
      break;
...
void updatePostprocessingInfo(Textlabel label, int postprocess) {
  switch(postprocess) {
  case 1: 
    label.setText("No Post-Processing"); 
    break;
  case 2: 
    label.setText("Exponential Decay"); 
    break;
  case 3: 
    label.setText("Low Pass Filter"); 
    break;
  case 4: 
    label.setText("Band Reject Filter"); 
    break;
  case 5: 
...
void generateSoundSequence() {
  ...
  for (int i = 1; i <= totalSounds; i++) {
    ...
    float stereo = float(i) / totalSounds;
    soundSequenceSamples.add(samples, stereo, (i - 1) * singleSoundDuration);
  }
